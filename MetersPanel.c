...
// we call them "Styles".
static const char* const MetersFunctions[] = {"Stil ", "Taşı  ", "                                         ", "Sil", "Tamam  ", NULL};
static const char* const MetersKeys[] = {"Boşluk", "Enter", "", "Del", "F10"};
...
static const char* const MetersMovingFunctions[] = {"Stil ", "Kilit  ", "Yukaru    ", "Aşağı  ", "Sol  ", "Sağ ", "       ", "Sil", "Tamam  ", NULL};
static const char* const MetersMovingKeys[] = {"Boşluk", "Enter", "Up", "Dn", "<-", "->", "  ", "Del", "F10"};
